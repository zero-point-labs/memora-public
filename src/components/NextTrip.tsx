...
export default function NextTrip() {
  return (
    <section id="next-trip" className="py-16 lg:py-24 bg-light-blue/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-coral/10 rounded-full px-4 py-2 mb-4">
            <Calendar className="h-5 w-5 text-coral" />
            <span className="text-coral font-medium">Next Adventure</span>
          </div>
        ...
        >
          <div className="relative bg-coral rounded-2xl p-8 overflow-hidden h-80 sm:h-96 flex flex-col justify-center items-center">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            {/* Trip info card */}
            <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-lg border border-coral/10 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                {activities.map((activity, index) => (
                  <motion.div
                    ...
                    className="bg-coral/5 rounded-xl p-4 text-center"
                  >
                    <activity.icon className="h-6 w-6 text-coral mx-auto mb-2" />
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-white rounded-xl p-4 text-center shadow-sm border border-coral/10">
                <Clock className="h-6 w-6 text-coral mx-auto mb-2" />
                <div className="text-2xl font-bold text-gray-900">3</div>
                <div className="text-sm text-gray-600">Days</div>
              </div>
              <div className="bg-white rounded-xl p-4 text-center shadow-sm border border-coral/10">
                <Users className="h-6 w-6 text-coral mx-auto mb-2" />
                <div className="text-2xl font-bold text-gray-900">12</div>
                <div className="text-sm text-gray-600">Max Group</div>
              </div>
              <div className="bg-white rounded-xl p-4 text-center shadow-sm border border-coral/10">
                <Star className="h-6 w-6 text-coral mx-auto mb-2" />
          ...
          >
            {/* What's included */}
            <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-lg border border-coral/10">
              ...
              <div className="space-y-3">
                {highlights.map((highlight, index) => (
                  ...
                  >
                    <div className="w-5 h-5 bg-coral/10 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div className="mt-6 p-4 bg-coral/5 rounded-xl border border-coral/20">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-coral font-medium">Limited Spots Available</span>
                </div>
