...
import { MapPin, Calendar, Star, Utensils, Camera, Music, Filter } from 'lucide-react'
...
export default function UpcomingTrips() {
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-teal/5 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-teal/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-teal font-medium">Upcoming Adventures</span>
          </div>
        ...
        >
          <div className="bg-white rounded-2xl p-4 shadow-lg border border-teal/10">
            ...
            >
              ...
              <div className="relative h-48 bg-gradient-to-br from-teal to-seafoam">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1">
                  <span className="text-sm font-medium text-teal">{trip.spotsLeft} spots left</span>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-teal">€{trip.price}</div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-6">
                  {trip.activities.slice(0, 4).map((activity, actIndex) => (
                    <div key={actIndex} className="bg-teal/5 rounded-lg p-3 text-center">
                      <activity.icon className="h-5 w-5 text-teal mx-auto mb-1" />
                ...
                <div className="space-y-3">
                  <Link
                    href={`/trips/${trip.id}`}
                    className="w-full bg-teal/10 text-teal font-medium py-3 px-6 rounded-xl hover:bg-teal/20 transition-all duration-200 flex items-center justify-center"
                  >
                    View Details
                  </Link>
                  <Link
                    href="#contact"
                    className="w-full bg-gradient-to-r from-teal to-seafoam text-white font-medium py-3 px-6 rounded-xl hover:shadow-lg hover:shadow-teal/25 transition-all duration-200 flex items-center justify-center"
                  >
                    Reserve Spot
                  </Link>
                </div>
        ...
        >
          <button className="bg-white text-teal font-medium py-3 px-8 rounded-xl border-2 border-teal/20 hover:bg-teal/5 transition-all duration-200">
            Load More Trips
          </button>
        </motion.div>
      </div>
