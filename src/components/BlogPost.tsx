...
export default function BlogPost({ post }: BlogPostProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ocean-blue-50 to-white">
      {/* Back Button */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <Link
          href="/blog"
          className="inline-flex items-center space-x-2 text-teal-600 hover:text-teal-700 font-medium transition-colors mb-8"
        >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex items-center space-x-4 mb-8">
              <button
                onClick={handleShare}
                className="flex items-center space-x-2 bg-teal-100 text-teal-600 px-4 py-2 rounded-xl hover:bg-teal-200 transition-colors"
              >
          ...
          <motion.div
            ...
            className="relative h-64 md:h-96 bg-gradient-to-br from-ocean-blue-400 to-teal-500 rounded-2xl overflow-hidden mb-12"
          >
      ...
      <section className="py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="bg-white rounded-2xl p-8 lg:p-12 shadow-lg border border-teal-100"
          >
            {/* Article Body */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-start space-x-6">
              <div className="w-16 h-16 bg-gradient-to-br from-ocean-blue-400 to-teal-500 rounded-full flex items-center justify-center flex-shrink-0">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-ocean-blue-500 to-teal-400">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/trips"
                className="bg-white text-teal-600 font-medium py-4 px-8 rounded-xl hover:bg-gray-50 transition-all duration-200 shadow-lg"
              >
                View Our Trips
              </Link>
              <Link
                href="/contact"
                className="bg-teal-600 text-white font-medium py-4 px-8 rounded-xl hover:bg-teal-700 transition-all duration-200"
              >
                Contact Us
              </Link>
            </div>
